...
export default async function AudioInterviewPage() {
      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-card via-card to-primary/5 p-8 shadow-2xl">
        ...
        <div className="relative">
          ...
          <p className="mt-3 max-w-xl text-sm text-muted-foreground">
            Core DSP and audio machine learning queries, from MFCC extraction pipelines to Nyquist sampling limits, with real-time confidence scores.
          </p>
        </div>
      </div>

      <QuestionListClient initialQuestions={questions} topic="audio" />
    </div>
  );
}
